...
export function ModalContent({ children, className = "" }: ModalContentProps) {
	...
	return createPortal(
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			{/* Modal */}
			<div
				className={`relative bg-white h-fit rounded-lg py-6 shadow-lg max-w-md w-full mx-4 z-10 overflow-y-auto max-h-screen [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300  dark:[&::-webkit-scrollbar-track]:bg-neutral-700  dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 ${className}`}
